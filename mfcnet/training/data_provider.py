...
class DataProvider:
    def __init__(self, N_u, data_container, ntrain, nvalid, batch_size=1, seed=None, randomized=False):
        ...
        self.dtypes_input["h1"] = tf.float32
        self.dtypes_input["h1_idx"] = tf.int32
        self.dtypes_input["h2"] = tf.float32
        self.dtypes_input["h2_idx"] = tf.int32
        self.dtypes_input["V_n"] = tf.float32
        ...
        self.shapes_input["h1"] = [None, 200]
        self.shapes_input["h1_idx"] = [None, 200, 2]
        self.shapes_input["h2"] = [None, 40000]
        self.shapes_input["h2_idx"] = [None, 40000, 4]
        self.shapes_input["V_n"] = [None, self.N_u]
        self.shapes_input["mo_neighbours_i"] = [None, None]
        self.shapes_input["mo_neighbours_j"] = [None, None]
        self.shapes_input["coupl"] = [None]
        self.shapes_input["gram"] = [None, 20, 20]
